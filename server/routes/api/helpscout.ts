			...
			"html": `
				...
				<ul class="c-sb-list c-sb-list--two-line">
					<li class="c-sb-list-item">
						<span class="c-sb-list-item__label">University<span class="c-sb-list-item__text">
							${user.applicationData ? findApplicationQuestion(user.applicationData, "university"): ""}</span>
						</span>
					</li>
					<li class="c-sb-list-item">
					...
					<li class="c-sb-list-item">
						<span class="c-sb-list-item__label">Applied?<span class="c-sb-list-item__text">${user.applicationSubmitTime}</span>
						</span>
					</li>
					<li class="c-sb-list-item">
						<span class="c-sb-list-item__label">Accepted?<span class="c-sb-list-item__text">${user.accepted ? "Yes" : "No"}</span>
						</span>
					</li>
					<li class="c-sb-list-item">
